...
<body>
    ...
    <div class="container-login"> 
		...
		<div class="wrap-login"> 
			<form action="../session/Sesion_ad.php" method="post"> 
        
				
				<span class="login-form-title">Ingreso Datos Admin.</span> 		
                <div class="container_c">
                    ...
                    <div class="column_1">
                        ...
                        <!--telefono movil-->
                        <div class="wrap-input100"> 
                            <input class="input100" type="text" name="telefono_m" placeholder="Telefono Celular" .> 
                            <span class="focus-efecto"></span> 
                        </div> 
                        <!--Genero--> <!--Input Select-->
                        <div class="wrap-input100"> 
                        ...
                        <!--Salario--> 
                        <div class="wrap-input100"> 
                            <input class="input100" type="text" name="salario" placeholder="Salario $" .> 
                            <span class="focus-efecto"></span> 
                        </div>                        
                        <!--Codigo Docente-->
                        <div class="wrap-input100"> 
                            <input class="input100" type="text" name="cod_docente" placeholder="Codigo Docente" . disabled> 
                            <span class="focus-efecto"></span> 
                        </div> 
                    ...
                    <div class="column_2">
                        ...
                        <!--Dependencia --> 
                        <div class="wrap-input100"> 
                            <input class="input100" type="text" name="dependencia" placeholder="Dependencia" .> 
                            <span class="focus-efecto"></span> 
                        </div> 
                        <!--Funcion --> 
                        <div class="wrap-input100"> 
                            <input class="input100" type="text" name="funcion" placeholder="Funcion" .> 
                            <span class="focus-efecto"></span> 
                        </div> 
                ...
                <a href="../session/Sesion_ad.php" name="otro">VER DATOS</a>         
			</form> 
