...
<body>
    ...
    <div class="container-login"> 
		...
		<div class="wrap-login"> 
			<form action="../session/Sesion_docente.php" method="post"> 
                ...
                <div class="container_c">
                    ...
                    <div class="column_1">
                        ...
                        <!-- Materia 1 --> 
                        <div class="wrap-input100"> 
                            <input class="input100" type="text" name="materia1" placeholder="Materia 1" >	 
                            <span class="focus-efecto"></span> 
                        </div>                                     
                                    
                        <!--Maeria 3--> 
                        <div class="wrap-input100"> 
                            <input class="input100" type="text" name="materia3" placeholder="Materia 3" > 
                            <span class="focus-efecto"></span> 
                        </div> 	    
                    ...
                    <div class="column_2">
                        ...
                        <!--Maeria 2--> 
                        <div class="wrap-input100"> 
                            <input class="input100" type="text" name="materia2" placeholder="Materia 2" > 
                            <span class="focus-efecto"></span> 
                        </div> 	    
                ...
                <a href="../session/Sesion_docente.php" name="otro">VER DATOS</a>
			</form> 
		</div> 
	</div> 
