			...
			<form action="" method="post"> 
                ...
                <div class="container_c">
                    ...
                    <div class="column_1">
                        ...
                        <!--GENERO--><!--AQUI IRIA UN INPUT SELECT-->
                        <div class="wrap-input100"> 
                    ...
                    <div class="column_2">
                        ...
                        <!--Dependencia --> 
                        <div class="wrap-input100"> 
                            <input class="input100" type="text" name="dependencia" placeholder="Dependencia" required> 
                            <span class="focus-efecto"></span> 
                        </div> 
                        <!--Funcion --> 
                        <div class="wrap-input100"> 
                            <input class="input100" type="text" name="funcion" placeholder="Funcion" required> 
                            <span class="focus-efecto"></span> 
                        </div> 
