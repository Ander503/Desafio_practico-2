			...
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"> 
                ...
                <div class="container_c">
                    ...
                    <div class="column_2">
                        ...
                        <!--Telefono Movil--> 
                        <div class="wrap-input100"> 
                            <input class="input100" type="text" name="telefono_m" placeholder="Telefono Movil" required> 
                            <span class="focus-efecto"></span> 
                        </div> 	 
                        <!--Genero--> <!--Input Select-->
                        <div class="wrap-input100"> 
                            <input class="input100" type="text" name="genero" placeholder="Genero" required> 
                            <span class="focus-efecto"></span> 
                        </div> 	                    
                        <!--Edad--> 
                        <div class="wrap-input100"> 
                        ...
                        <!--Codigon Estudiante--> 
                        <div class="wrap-input100"> 
                            <input class="input100" type="text" name="cod_estudiante" placeholder="Codigo Estudiante" required disabled> 
                            <span class="focus-efecto"></span> 
                        </div> 	
