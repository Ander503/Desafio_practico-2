...
//aun no esta
 public function Calcular_Salario($horas_t){
   $trabajo_horas=$this->Horas_trabajadas=$horas_t;
   $_pago_h=$this->PagoPorHora="10.50";

   $sal=$this->salario=$trabajo_horas*$_pago_h;
