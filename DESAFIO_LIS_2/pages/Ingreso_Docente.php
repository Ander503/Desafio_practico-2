  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Lista de Docentes</h5>
                ...
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                  <div class="row col-12" >
                    <div class="col-6 p-0" style="text-align: left; color: #000000;">
                        ...
                        <h6 class="my-0">
                        Materia 1: <?php echo $carrito_mio[$i]['materia1'] ?> 
                        </h6>
                        <h6 class="my-0">
                        Materia 2: <?php echo $carrito_mio[$i]['materia2'] ?> 
                        </h6>
                        <h6 class="my-0">
                        Materia 3: <?php echo $carrito_mio[$i]['materia3'] ?> 
                        </h6>                                              
                        <h6 class="my-0">
                        Salario Calculado: <?php echo $carrito_mio[$i]['salario'] ?> 
                        </h6>                                              
                    </div>                
                  </div>
              </li>
      ...
      <div class="modal-footer">
        ...
        <?php 
         ...
         ?>
        <a type="button" class="btn btn-primary" href="../borrarcarro.php">Borrar docentes</a>
      </div>
    </div>
  </div>
</div>
...
<div class="container mt-5">
  ...
  <div class="card m-4" style="width: 30rem;">
      <form id="formulario" name="formulario" method="post" action="../session/Session_Docente.php">
      <div  style="text-align: center; margin-top:10px;">                
        <img src="../img/docente.png" class="card-img-top" alt="..." style="width: 100px;height:100px ;align-items: center;"  ;"  >
        </div>
                  <div class="card-body">
                          <a>Nombre</a>
                          ...
                          <a>Materia1</a>
                          <input name="materia1" id= materia1 type="text" class="form-control"required>
                          <a>Materia2</a>
                          <input name="materia2" id= materia2 type="text" class="form-control"required>
                          <a>Materia3</a>
                          <input name="materia3" id= materia3 type="text" class="form-control"required>
                          <a>Horas Trabajadas</a>
                          <input name="horas_t" type="text" class="form-control"required>
                          <button class="btn btn-primary" type="submit" ><i class="fa-solid fa-user"></i> Añadir Docente</button>
                </div>
        </form>
    </div>
  </div>
